...
const completeRegistration = async (req, res) => {
  try {
    ...
    if (!user) {
      return res.status(400).send({ success: false, message: "User not verified or does not exist" });
    }
...
module.exports = {
  SentOtp,loginUser,verifyOtp,completeRegistration,forgotPassword,verifyForgotPasswordOtp,resetPassword,isLoggedin
}